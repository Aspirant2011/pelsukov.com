...
class Faces extends CI_Controller {
	...
	public function index()
	{
		...
		$products = $this->scripts_model->get_product_by_module('module_faces');
		...
		$news = $this->products_model->get_news_list($current_lang, 'module_faces', 3);
		$this->display_lib->assign('news', $news);
		
		$this->display_lib->view('faces_page');
	}
}