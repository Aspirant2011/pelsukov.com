...
<head>
   <meta charset="utf-8">
	<title><?=$langs['seo_title_sms_notifications_basic']?></title>
	<meta name="description" content="<?=$langs['seo_description_sms_notifications_basic']?>">
	<meta name="keywords" content="<?=$langs['seo_keywords_sms_notifications_basic']?>">
	...
	<script src="<?=base_url();?>application/views/js/sms_notifications_basic_init.js"></script>
	...
	<!-- end #nav-wrap -->
      <div class="row">
         <div class="three columns header-col">
            <img src="<?=base_url();?>application/views/images/portfolio/module_sms_notifications_basic/image_1.jpg"/>
         </div>
         <div class="nine columns main-col">
            <h2><?=$langs['projects_sms_notifications_basic_module']?></h2>
            <p><?=$langs['projects_sms_notifications_basic_module_description_1']?></p>
				...
				<div class="ten columns flex-container">
					<div class="flexslider">
						<ul class="slides">
							...
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_sms_notifications_basic/image_2.png">
							</li>
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_sms_notifications_basic/image_4.png">
							</li>
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_sms_notifications_basic/image_3.png">
							</li>
						</ul>
