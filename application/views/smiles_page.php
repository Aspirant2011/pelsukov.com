...
<head>
   <meta charset="utf-8">
	<title><?=$langs['seo_title_smiles']?></title>
	<meta name="description" content="<?=$langs['seo_description_smiles']?>">
	<meta name="keywords" content="<?=$langs['seo_keywords_smiles']?>">
	...
	<script src="<?=base_url();?>application/views/js/smiles_init.js"></script>
	...
	<!-- end #nav-wrap -->
      <div class="row">
         ...
         <div class="three columns header-col">
            <img src="<?=base_url();?>application/views/images/portfolio/module_smiles/logo.gif"/>
         </div>

         <div class="nine columns main-col">

            <h2><?=$langs['projects_smiles_module']?></h2>

            <p><?=$langs['projects_smiles_module_description_1']?></p>
            <p><?=$langs['projects_smiles_module_description_2']?></p>
				...
				<div class="ten columns flex-container">
					...
					<div class="flexslider">
						...
						<ul class="slides">
							...
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_smiles/image_5.png">
							</li> <!-- slide ends -->

							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_smiles/image_4.png">
							</li> <!-- slide ends -->
							
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_smiles/image_3.png">
							</li> <!-- slide ends -->

							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_smiles/image_1.png">
							</li> <!-- slide ends -->

							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_smiles/image_2.png">
							</li> <!-- slide ends -->
				...
				<form action="<?=base_url();?>buy" method="post" id="paydForm" name="paydForm">
					...
					<fieldset>
						...
						<div style="margin-left:165px">
							<h4>OR</h4>
							<iframe frameborder="0" allowtransparency="true" scrolling="no" src="https://money.yandex.ru/embed/small.xml?account=41001893440656&quickpay=small&any-card-payment-type=on&button-text=02&button-size=m&button-color=orange&targets=Smiles+for+your+site&default-sum=3000&successURL=http%3A%2F%2Fpelsukov.com%2Fbuy%2Fresponse%2Fyandex" width="160" height="42"></iframe>
						</div>
