...
<head>
   <meta charset="utf-8">
	<title><?=$langs['seo_title_captcha']?></title>
	<meta name="description" content="<?=$langs['seo_description_captcha']?>">
	<meta name="keywords" content="<?=$langs['seo_keywords_captcha']?>">
   ...
   <section id="about">
		...
		<div class="row">
			<div class="three columns header-col">
				<img src="<?=base_url();?>application/views/images/portfolio/module_captcha/marketplace_robot_thumb.png"/>
			</div>
			<div class="nine columns main-col">
				<h2><?=$langs['projects_captcha_module']?></h2>
				<p><?=$langs['projects_captcha_module_description_1']?></p>
				<p><?=$langs['projects_captcha_module_description_2']?></p>
				<ul class="disc">
					<li><?=$langs['projects_captcha_module_description_3']?></li>
					<li><?=$langs['projects_captcha_module_description_4']?></li>
					<li><?=$langs['projects_captcha_module_description_5']?></li>
				</ul>
			...
			<div class="row">
				...
				<div class="ten columns flex-container">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_captcha/image6.jpg" style="height:500px">
							</li> <!-- slide ends -->
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_captcha/image7.jpg" style="height:500px">
							</li> <!-- slide ends -->
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_captcha/image8.jpg" style="height:500px">
							</li> <!-- slide ends -->
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_captcha/image9.jpg" style="height:500px">
							</li> <!-- slide ends -->
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_captcha/image10.jpg" style="height:500px">
							</li> <!-- slide ends -->
							<li>
								<img src="<?=base_url();?>application/views/images/portfolio/module_captcha/image11.jpg" style="height:500px">
							</li> <!-- slide ends -->
						</ul>
         ...
         <div class="row">
            <div class="eight columns">
				...
				<form action="<?=base_url();?>buy" method="post" id="paydForm" name="paydForm">
					...
					<fieldset>
						...
						<!--div>
							<div style="margin:15px 0; overflow:hidden;">
								<input type="checkbox" value="1" id="pay_rub" name="pay_rub" style="width:35px"><?=$langs['pay_to_rub']?>
							</div>
						</div-->
						<div>
			...
			<aside class="four columns footer-widgets">
				<div class="widget widget_contact">
					...
					<input type="hidden" name="hosted_button_id" value="C3692RTNLQHVL">
					<table>
					<tr><td><input type="hidden" name="on0" value="Please select your PG script">Please select your PG script</td></tr><tr><td><select name="os0">
						<option value="PG Dating Pro 2015">PG Dating Pro 2015 </option>
						<option value="PG SocialBiz 2014">PG SocialBiz 2014 </option>
					</select> </td></tr>
					<tr><td><input type="hidden" name="on1" value="Your email">Your email</td></tr><tr><td><input type="text" name="os1" maxlength="200"></td></tr>
					</table>
					...
					<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="N82SWEKF6ZMRW">
