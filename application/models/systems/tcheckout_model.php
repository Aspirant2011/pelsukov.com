...
class Tcheckout_model extends Payment_driver_model
{
	...
	private $notifications_variables = array(
		"vendor_id" => "seller_id",
	...
	private $currencies = array('ARS', 'AUD', 'BRL', 'GBP', 'CAD', 'DKK', 'EUR', 'HKD', 
	...
	public function func_responce($payment_data, $system_settings){
		...
		if(isset($return['data']['id_payment'])) $return['data']['id_payment'] = str_replace('CART-', '', $return['data']['id_payment']);
