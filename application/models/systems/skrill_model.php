...
class Skrill_model extends Payment_driver_model
{
	...
	private $checkout_url = 'https://www.moneybookers.com/app/payment.pl';
		
	private $test_checkout_url = 'https://www.moneybookers.com/app/test_payment.pl';
	...
	public function func_responce($payment_data, $system_settings){
		...
		if($error){
			...
			switch($return["data"]["status"]){
				case 2: $return["data"]["status"] = 1; break;
				case 0: $return["data"]["status"] = 0; break;
				default: $return["data"]["status"] = -1; break;
			}
		}
